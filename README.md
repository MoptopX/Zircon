> Note: Zircon is old and outdated and I decided to upload these files shortly before its death. Zircon has evolved into more advanced, closed source project called [Nekovault](https://www.nekovault.moe/), this project is not availible on github but if you wish you can explore and use the old code of Zircon however you wish.
